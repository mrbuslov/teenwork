...
lang_checkbox.onchange = function() {
  if (lang_checkbox.checked) {
    ...
    if(url.includes('/others_page/')){
      if(getCookie('theme') === 'dark'){
        document.getElementsByClassName('ru')[0].style.color = '#fff';
        document.getElementsByClassName('ru')[1].style.color = '#fff';
      }
    }
  }
  ...
  if(getCookie('lang') === 'ru'){
    ...
    document.cookie = "lang=ru; path=/; max-age=2592000; samesite=lax";
...
if(getCookie('lang') === 'uk'){
  ...
  if(document.querySelector('.ru')){
    ...
    document.getElementsByClassName('ru')[0].style.color = '#c6c6c6';
  }
  ...
  if(document.querySelector('.ru')){
    document.getElementsByClassName('ru')[0].style.color = '#000';
...
if(url.includes('/uk/')){
  ...
  if(url.includes('/others_page/')){
    ...
    document.getElementsByClassName('ru')[1].style.color = '#c6c6c6';
  }
}
else{
  if(lang_checkbox){
  ...
  if(url.includes('/others_page/')){
    document.getElementsByClassName('ru')[1].style.color = '#000';
