      ...
      $.ajax({
          ...
          success: function(data) {
              for (let index = 0; index < 3; index++) {
                try{
                  $(`#photo${index+1}`).html('<img src="' + data.data[index] + '" onError="this.style.display=\'none\'" style="object_fit: cover; width:100%; height:100%;" id="photo1_img"/>');
                  $(`#photo${index+1}_id`).val(data.ids[index]);
